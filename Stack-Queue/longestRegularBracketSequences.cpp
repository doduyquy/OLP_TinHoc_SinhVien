...
void countTruePairBracket(string input){
    int counter = 0; 
    int countSub = 0; bool check = false;
    int max = 0;
...
// int countTruePairBracket(string input, int &countSub){
//     int counter = 0;
//     countSub = 0; bool check = false;
